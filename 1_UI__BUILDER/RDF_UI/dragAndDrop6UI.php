...
<div class="section" style=" display:flex; flex-direction:row;justify-content:space-evenly; margin-top:-20px;">
    ...
    <div style=" display:flex; flex-direction:row; justify-content:end; margin-right:-30px; ">
                    <button class="btn" style="background:none; border:none;" onclick="clearDropzone6AndStorage()"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#4f4e4e"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg></button>
...
<table class="section" style="align-items: center;width: 303.2px ;position: relative;height: 500.2px; margin-top:0px;">
    <tr>
        <td style="border: 5px solid #333; border-radius:20px;   margin:10px 5px; text-align: center; font-size:1rem; max-height:auto; display:flex; margin-left:2px; flex-direction:column;  min-height:480px; width:280px; align-items: center; position: relative;" id="dropzone6" class="dropzone6">          
        </td>
    </tr>
</table>
</center>
...
<div class="content-container"  style="  position:absolute; bottom:5px; left:-11px; width:20px;">
    ...
    <div id="content4" class="content" style="display: none; font-size: 0.8rem; white-space: nowrap;">
        Canva Color <input type="color" id="dropzone6BgColorInput" value="#ffffff">
    </div>
...
<!-- download button script complete -->    
    <script src="RDF_ACTION/dragAndDrop6Action.js"></script>
